...
// 1. Import the CSS module styles
import * as styles from "./header.module.css"

const Header = ({ siteTitle }) => (
  // 2. Use the imported class name: styles.headerContainer
  <header className={styles.headerContainer}>
    <Link
      to="/"
      // 3. Use the imported class name: styles.siteTitle
      className={styles.siteTitle}
    >
      {siteTitle}
    </Link>

    {/* 4. Use the imported class name: styles.navAndLogo */}
