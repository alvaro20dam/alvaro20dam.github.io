...
* **Data Analysis & Visualization**: `Tableau`, `Excel` (Advanced Functions, VBA, Pivot Tables), `Power BI`, `Power query`
...
**IT Services Analyst @ Grotool LLC, [Georgia & Florida, USA]**
January 2020 – May 2025

* Spearheaded data analysis and reporting for a multinational H2A agricultural human resources department, leveraging Excel, DBeaver, and SQL to optimize workforce management.
* Optimized workforce management, leading to 25% reduction in processing time for H2A contracts.
* Developed and maintained complex SQL queries to extract, transform, and load critical HR data, enabling efficient processing of international contracts and compliance requirements.
* Provided key insights into HR metrics, informing decisions that reduced recruitment costs by 11%.
* Designed and implemented custom Excel-based analytical tools and dashboards, providing key insights into HR metrics such as recruitment cycles, workforce deployment, and compliance status for a large agricultural conglomerate.
* Collaborated cross-functionally to identify data-driven solutions for operational bottlenecks within the HR department, directly contributing to streamlined processes and improved data accuracy.
* Ensured data accuracy for over 1000+ international contracts annually, minimizing compliance risks.

**Financial Advisor @ Fintech Communications - Self-Employed/Consultant - [Valencia, Venezuela]**
October 2017 – October 2020

* Conducted rigorous analysis of international financial markets and decentralized finance (DeFi) protocols to develop data-driven investment strategies, optimizing company resource allocation by up to 12%.
* Advised on and managed portfolios incorporating diverse blockchain-based assets (spot & futures trading, on-chain mining via PoW/PoS, liquidity farming, long-term holding, and smart contract applications), consistently aiming for enhanced returns.
* Translated complex tokenomics and market dynamics into actionable insights, enabling informed decision-making for optimal capital allocation within the crypto ecosystem, significantly improving investment outcomes.

**Cost Manager @ Sercoinfal, C.A., [Valencia, Venezuela]**
December 2010 – November 2013

* Directed resource optimization strategies across a conglomerate of 20+ industrial canteens, maintaining company profitability through stringent cost control.
* Conducted comprehensive data analysis of raw and processed materials, inventory levels, and operational controls, leveraging advanced Excel functionalities for detailed financial modeling and variance reporting.
* Developed and implemented robust analytical frameworks in Excel to track key performance indicators (KPIs) related to consumption, waste, and procurement, improving cost efficiency by up to 8%.
* Provided critical insights from complex datasets to senior management, informing strategic decisions that directly contributed to sustaining profit margins in a dynamic industrial environment.

**National Statistics Analyst @ Banco Central de Venezuela, [Caracas, Venezuela]**
June 2008 – December 2009

* Conducted in-depth analysis and developed national surveys targeting the mining industry, providing crucial data for economic assessments.
* Monitored and analyzed non-precious metal prices within the Venezuelan mining statistics department, directly contributing to the accurate calculation of National GDP.
* Designed comprehensive forms for the 2008-2009 monetary reconversion, ensuring seamless data collection and analysis during a significant national economic transition.
* Leveraged statistical software and advanced Excel functionalities to process large datasets, ensuring data integrity and generating precise economic indicators.
